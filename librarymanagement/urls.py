...
urlpatterns = [
    ...
    path('change-password-admin',auth_views.PasswordChangeView.as_view(template_name='password/change-password-admin.html',success_url = 'afterlogin'), name='changepassword_admin'),
